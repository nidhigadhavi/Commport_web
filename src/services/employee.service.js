 ...
 * Purpose : Service for the Employee.
 */
...
function getEmployee(id) {
    console.log("GET EMPLOYEEEEEEEEE");
    console.log(id);
    let data = JSON.parse(localStorage.getItem('user'));
    let authorization = data.data.data;
    const requestOptions = {
        method: 'GET',
        url: urlEndPoint + "/findemp?email='" + id + "'",
        headers: { 'authorization': data.data.data }
    };
    
    return axios(requestOptions)
        .then(result => {
            console.log('@#@#@#@ employee from get by email is as following..');
            console.log(result);
...
function getEmployeeList() {
    ...
    const requestOptions = {
        method: 'GET',
        url: urlEndPoint + "/employeesForGrid?p=1&r=100",
        headers: { 'authorization': data.data.data }
    };
...
function uploadEmployee(uploadedCsv) {
    console.log("SERVICE Employee CALLED...");
    ...
    const requestOptions = {
        method: 'POST',
        url: urlEndPoint + "/uploadData",
        body: uploadedCsv,
        headers: { 'Content-Type': 'application/json', 'authorization': data.data.data }
    };

    return axios(requestOptions)
        .then(result => {
            console.log("#####result### UPLOAD CSV");
            var respone = result.data.data;
            console.log(result);
            return result;
        })
...
function downloadEmployee() {
    console.log("SERVICE Employee Dowload CALLED...");
    let data = JSON.parse(localStorage.getItem('user'));
    let authorization = data.data.data;

    const requestOptions = {
        method: 'GET',
        url: urlEndPoint + "/employees?p=1&r=100",
        headers: { 'authorization': data.data.data }
    };

    return axios(requestOptions)
        .then(result => {
            console.log("#####result### download thes CSV");
            var respone = result.data.data;
            console.log(result);
            return result;
        })
...
function handleResponse(response) {
    return response.then(text => {
        if (response.statusCode === 400) {
            ...
            console.log("inot the response handler::::::::");
